...
public class EAutoBanProfile extends EAuto implements SanctionAuto.SanctionBanProfile {
	
	public EAutoBanProfile(final UUID uuid, final long creation, final Optional<Long> expiration, final SanctionAuto.Reason reason, final SanctionAuto.Type type, final int level, 
			final String source) {
