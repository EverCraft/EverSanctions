...
public class EAutoMute extends EAuto implements SanctionAuto.SanctionMute {
		
	public EAutoMute(final UUID uuid, final long creation, final Optional<Long> expiration, final SanctionAuto.Reason reason, final SanctionAuto.Type type, final int level, 
			final String source) {
