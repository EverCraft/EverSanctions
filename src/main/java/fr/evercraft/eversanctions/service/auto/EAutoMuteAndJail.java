...
public class EAutoMuteAndJail extends EAuto implements SanctionAuto.SanctionMuteAndJail {
	
	private final String jail;
	
	public EAutoMuteAndJail(final UUID uuid, final long creation, final Optional<Long> expiration, final SanctionAuto.Reason reason, final SanctionAuto.Type type, final int level, 
