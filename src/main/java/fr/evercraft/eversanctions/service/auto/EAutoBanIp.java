...
public class EAutoBanIp extends EAuto implements SanctionAuto.SanctionBanIp {
	
	private final InetAddress address;
	
	public EAutoBanIp(final UUID uuid, final long creation, final Optional<Long> expiration, final SanctionAuto.Reason reason, final SanctionAuto.Type type, final int level, 
