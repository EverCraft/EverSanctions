...
public class ESMessage extends EMessage<EverSanctions> {
	...
	public enum ESMessages implements EnumMessage {
		...
		PERMISSIONS_COMMANDS_PROFILE_EXECUTE("permissionsCommandsProfileExecute", ""),
		PERMISSIONS_COMMANDS_PROFILE_OTHERS("permissionsCommandsProfileOthers", ""),
		PERMISSIONS_COMMANDS_SANCTIONS_EXECUTE("permissionsCommandsSanctionsExecute", ""),
		PERMISSIONS_COMMANDS_SANCTION_EXECUTE("permissionsCommandsSanctionExecute", ""),
		PERMISSIONS_COMMANDS_SANCTION_OFFLINE("permissionsCommandsSanctionOffline", ""),
		PERMISSIONS_COMMANDS_UNSANCTION_EXECUTE("permissionsCommandsUnsanctionExecute", ""),
		PERMISSIONS_COMMANDS_BAN_EXECUTE("permissionsCommandsBanExecute", ""),
		PERMISSIONS_COMMANDS_BAN_UNLIMITED("permissionsCommandsBanUnlimited", ""),
		PERMISSIONS_COMMANDS_BAN_OFFLINE("permissionsCommandsBanOffline", ""),
		PERMISSIONS_COMMANDS_BANIP_EXECUTE("permissionsCommandsBanipExecute", ""),
		PERMISSIONS_COMMANDS_BANIP_UNLIMITED("permissionsCommandsBanipUnlimited", ""),
		PERMISSIONS_COMMANDS_BANIP_OFFLINE("permissionsCommandsBanipOffline", ""),
		PERMISSIONS_COMMANDS_MUTE_EXECUTE("permissionsCommandsMuteExecute", ""),
		PERMISSIONS_COMMANDS_MUTE_UNLIMITED("permissionsCommandsMuteUnlimited", ""),
		PERMISSIONS_COMMANDS_MUTE_OFFLINE("permissionsCommandsMuteOffline", ""),
		PERMISSIONS_COMMANDS_JAIL_EXECUTE("permissionsCommandsJailExecute", ""),
		PERMISSIONS_COMMANDS_JAIL_UNLIMITED("permissionsCommandsJailUnlimited", ""),
		PERMISSIONS_COMMANDS_JAIL_OFFLINE("permissionsCommandsJailOffline", ""),
		PERMISSIONS_COMMANDS_JAILS_EXECUTE("permissionsCommandsJailsExecute", ""),
		PERMISSIONS_COMMANDS_JAILS_ADD("permissionsCommandsJailsAdd", ""),
		PERMISSIONS_COMMANDS_JAILS_DELETE("permissionsCommandsJailsDelete", ""),
		PERMISSIONS_COMMANDS_JAILS_LIST("permissionsCommandsJailsList", ""),
		PERMISSIONS_COMMANDS_JAILS_TELEPORT("permissionsCommandsJailsTeleport", ""),
		PERMISSIONS_COMMANDS_JAILS_SETRADIUS("permissionsCommandsJailsSetRadius", ""),
		PERMISSIONS_COMMANDS_UNBAN_EXECUTE("permissionsCommandsUnbanExecute", ""),
		PERMISSIONS_COMMANDS_UNBANIP_EXECUTE("permissionsCommandsUnbanipExecute", ""),
		PERMISSIONS_COMMANDS_UNMUTE_EXECUTE("permissionsCommandsUnmuteExecute", ""),
		PERMISSIONS_COMMANDS_UNJAIL_EXECUTE("permissionsCommandsUnjailExecute", ""),;
